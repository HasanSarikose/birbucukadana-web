...
$.extend( KeyTable.prototype, {
	...
	/**
	 * Perform excel like navigation for Editor by triggering an edit.blade.php on key
	 * press
	 *
	...
	_editor: function ( key, orig, hardEdit )
	{
		...
		// Do nothing if there is already an inline edit.blade.php in this cell
		...
		var editInline = function () {
			...
			editor
				.one( 'open'+namespace, function () {
					...
					// Highlight the cell a different colour on full edit.blade.php
					if ( hardEdit ) {
	...
	_key: function ( e )
	{
		...
		switch( e.keyCode ) {
			...
			case 113: // F2 - Excel like hard edit.blade.php
				if ( this.c.editor ) {
