...
(function(mod) {
  ...
  var Vim = function() {
    ...
    function maybeInitVimState(cm) {
      if (!cm.state.vim) {
        ...
        cm.state.vim = {
          ...
          // Vim's input state that triggered the last edit.blade.php, used to repeat
          // motions and operators with '.'.
          lastEditInputState: undefined,
          // Vim's action command before the last edit.blade.php, used to repeat actions
    ...
    function onCursorActivity(cm) {
      ...
      if (vim.insertMode) {
        ...
        if (lastChange.expectCursorActivityForChange) {
          ...
          // Cursor moved outside the context of an edit.blade.php. Reset the change.
    ...
    */
    ...
    /**
     * Repeats the last edit.blade.php, which includes exactly 1 command and at most 1
