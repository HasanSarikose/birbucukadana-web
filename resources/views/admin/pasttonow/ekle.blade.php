    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{route('pasttonoweklePost')}}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                        </div>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <label>Geçmişten Günümüze Fotoğraf Yükle</label>
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="form-group">
                                    <label>Geçmişten Günümüze Başlık Yazısı Ekle</label>
                            ...
                            <div class="col-sm-12">
                                <!-- text input -->
                                <div class="form-group">
                                    <label>Geçmişten Günümüze Açıklama Yazısı Ekle</label>
                                    <textarea class="form-control" rows="3" name="yazi" id="yazi" required></textarea>
                                </div>
                            </div>
                            <br>
                        </div>
