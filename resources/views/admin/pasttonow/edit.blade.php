    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{route('pasttonoweditPost', ['id' => $pasttonow->id])}}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                        </div>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <div class="form-group">
                                    <label>Geçmişten Günümüze Başlık Düzenle</label>
                                    <textarea class="form-control" rows="3" name="baslik" id="baslik" required>{{ old('baslik', $pasttonow->baslik) }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-12">
                                <!-- text input -->
                                <div class="form-group">
                                    <label>Geçmişten Günümüze Açıklama Düzenle</label>
                                    <textarea class="form-control" rows="3" name="yazi" id="yazi" required>{{ old('hakkinda', $pasttonow->yazi) }}</textarea>
                                </div>
                            </div>

                            <div class="col-sm-6">
                                <label>Geçmişten Günümüze Fotoğraf Düzenle</label>

                                @if($pasttonow->image)
                                    <div class="mb-3">
                                        <img src="{{ asset($pasttonow->image) }}" alt="Mevcut Fotoğraf" class="img-fluid" id="preview-image">
                                    </div>
                                @endif
