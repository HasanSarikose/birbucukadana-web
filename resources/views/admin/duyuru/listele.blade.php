@php
    $data=\Illuminate\Support\Facades\DB::table('duyuru')->get();
@endphp
    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{route('duyuruarama')}}" method="post">
                        @csrf
                        <div class="row">
                            <div class="col-sm-6">
                                <!-- text input -->
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                ...
                                                <div class="dropdown-menu" role="menu">
                                                    <a class="dropdown-item" href="{{route('duyuruedit',['id'=>$item->id])}}">Güncelle</a>
