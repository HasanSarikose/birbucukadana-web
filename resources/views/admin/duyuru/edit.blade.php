    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{route('duyurueditPost', ['id' => $duyuru->id])}}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                        </div>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <div class="form-group">
                                    <label>Duyuru Başlık Düzenle</label>
                                    <textarea class="form-control" rows="3" name="baslik" id="baslik" required>{{ old('baslik', $duyuru->baslik) }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" rows="3" name="aciklama" id="aciklama" required>{{ old('hakkinda', $duyuru->aciklama) }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6">
                                ...
                                @if($duyuru->image)
                                    <div class="mb-3">
                                        <img src="{{ asset($duyuru->image) }}" alt="Mevcut Fotoğraf" class="img-fluid" id="preview-image">
                                    </div>
                                @endif
