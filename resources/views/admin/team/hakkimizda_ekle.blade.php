    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{route('ThakkimizdaeklePost')}}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                        </div>
                        ...
                        <div class="row">
                            <div class="col-sm-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" rows="3" name="teamid" id="teamid" required></textarea>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <!-- text input -->
                                <div class="form-group">
                                    <label>Hakkımızda Başlık Yazısı Ekle</label>
                                    <textarea class="form-control" rows="3" name="baslik" id="baslik" required></textarea>
                                </div>
                            </div>
                            <br>
                            <div class="col-sm-4">
                            ...
                            <div class="col-sm-12">
                                <!-- text input -->
                                <div class="form-group">
                                    <label>Hakkımızda Açıklama Yazısı Ekle</label>
