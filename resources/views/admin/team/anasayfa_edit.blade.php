    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('TanasayfaUpdate', $tanasayfa->id ?? 1) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row mt-3">
                            <div class="col-sm-6">
                                <label>Başlık</label>
                                <input type="text" class="form-control" name="anasayfa" value="{{ old('title', $tanasayfa->anasayfa) }}" required>
                            </div>
                        </div>
                        ...
                        <div class="row mt-3">
                            <div class="col-sm-6">
                                ...
                                @if($tanasayfa->image)
                                    <div class="mb-2">
                                        <img src="{{ asset($tanasayfa->image) }}" alt="Başarı Görseli" class="img-fluid" id="preview-image">
                                    </div>
                                @endif
