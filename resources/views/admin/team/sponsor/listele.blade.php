                                        ...
                                        <td>
                                            <div class="btn-group">
                                                ...
                                                <div class="dropdown-menu" role="menu">
                                                    <a class="dropdown-item" href="{{route('SponsorEdit', ['id' => $item->id])}}">Güncelle</a>
                                                    <a class="dropdown-item" href="{{ route('SponsorSil', ['id' => $item->id, 'team_slug' => $item->team->slug]) }}">Sil</a>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
