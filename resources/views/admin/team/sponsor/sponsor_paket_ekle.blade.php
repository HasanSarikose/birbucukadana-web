    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{route('SponsorPaketEklePost')}}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                        </div>
                        ...
                        <div class="row">
                            <div class="col-sm-1">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" rows="3" name="team_id" id="team_id" required></textarea>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <!-- text input -->
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" rows="3" name="title" id="title" required></textarea>
                                </div>
                            </div>
                            <br>
                            <div class="col-sm-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" rows="3" name="order" id="order" required></textarea>
                                </div>
                            </div>
