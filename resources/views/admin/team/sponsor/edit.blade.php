    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{route('SponsorUpdate', $sponsor->id)}}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                        </div>
                        ...
                        <div class="row">
                            <div class="col-sm-1">
                                ...
                                <div class="form-group">
                                    <label>Takım İD</label>
                                    <textarea class="form-control" rows="1" name="team_id" id="team_id" required>{{$team->id}}</textarea>
                                </div>
                            </div>
                            <div class="col-sm-2">
                                <!-- text input -->
                                <div class="form-group">
                                    <label>Sponsor Paket İD</label>
                                    <textarea class="form-control" rows="1" name="package_id" id="package_id" required>{{$packages->order}}</textarea>
                                </div>
                            </div>
                            <br>
                            <div class="row mt-6">
                                <div class="col-sm-6">
                                    ...
                                    @if($sponsor->logo_path)
                                        <div class="mb-3">
                                            <img src="{{ asset($sponsor->logo_path) }}" alt="Mevcut Fotoğraf" class="img-fluid" id="preview-image">
                                        </div>
                                    @endif
                            ...
                            <div class="col-sm-12">
                                <!-- text input -->
                                <div class="form-group">
                                    <label>Sponsor İsmi Ekle</label>
                                    <textarea class="form-control" rows="3" name="name" id="name" required>{{$sponsor->name}}</textarea>
                                </div>
                            </div>
