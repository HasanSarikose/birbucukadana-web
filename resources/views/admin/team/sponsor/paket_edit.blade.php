    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{route('SponsorPaketUpdate', $packages->id)}}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                        </div>
                        ...
                        <div class="row">
                            <div class="col-sm-1">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" rows="2" name="team_id" id="team_id" required>{{$packages->team_id}}</textarea>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <!-- text input -->
                                <div class="form-group">
                                    <label>Sponsorluk Paket İsmi</label>
                                    <textarea class="form-control" rows="3" name="title" id="title" required>{{$packages->title}}</textarea>
                                </div>
                            </div>
                            <br>
                            <div class="col-sm-2">
                                <!-- text input -->
                                <div class="form-group">
                                    <label>Sponsorluk Derece Ekle</label>
                                    <textarea class="form-control" rows="2" name="order" id="order" required>{{$packages->order}}</textarea>
                                </div>
                            </div>
