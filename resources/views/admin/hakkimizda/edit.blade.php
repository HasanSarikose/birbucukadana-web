    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{route('hakkimizdaeditPost', ['id' => $hakkimizda->id])}}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                        </div>
                        ...
                        <div class="col-sm-6">
                            <label>Hakkımızda Fotoğraf Yükle</label>
                            <!-- Gösterilecek mevcut fotoğraf -->
                            @if($hakkimizda->image)
                                <div class="mb-3">
                                    <img src="{{ asset($hakkimizda->image) }}" alt="Mevcut Fotoğraf" class="img-fluid" id="preview-image">
                                </div>
                            @endif
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <div class="form-group">
                                    <label>Hakkimizda Açıklama Düzenle</label>
                                    <textarea class="form-control" rows="3" name="hakkimizda" id="hakkimizda" required>{{ old('$hakkimizda', $hakkimizda->hakkimizda) }}</textarea>
                                </div>
                            </div>
