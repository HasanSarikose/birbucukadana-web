    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{route('anasayfaeklePost')}}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                        </div>
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                ...
                                <div class="form-group">
                                    <label>Başlık Yazısı Ekle</label>
                            ...
                            <div class="col-sm-12">
                                <!-- text input -->
                                <div class="form-group">
                                    <label>Hakkında Yazısı Ekle</label>
                                    <textarea class="form-control" rows="3" name="anasayfa" id="anasayfa" required></textarea>
                                </div>
                            </div>
                            <br>
                            <div class="col-sm-6">
