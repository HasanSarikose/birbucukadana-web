    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{route('anasayfaeditPost', ['id' => $anasayfa->id ?? 1])}}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                        </div>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <div class="form-group">
                                    <label>AnaSayfa Başlık Düzenle</label>
                                    <textarea class="form-control" rows="3" name="baslik" id="baslik" required>{{ old('baslik', $anasayfa->baslik) }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-12">
                                <!-- text input -->
                                <div class="form-group">
                                    <label>AnaSayfa Açıklama Düzenle</label>
                                    <textarea class="form-control" rows="3" name="anasayfa" id="anasayfa" required>{{ old('hakkinda', $anasayfa->anasayfa) }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6">
                                ...
                                @if($anasayfa->image)
                                    <div class="mb-3">
                                        <img src="{{ asset($anasayfa->image) }}" alt="Mevcut Fotoğraf" class="img-fluid" id="preview-image">
                                    </div>
                                @endif
